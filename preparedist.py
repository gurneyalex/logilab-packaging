...
if [ "$1" = "" -o "$1" = "--help" -o "$1" = "-h" ]; then
    ...
    if [ "$PKGTYPE" = "python" ]; then
        echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
        cond_exec pylint && while true; do pylint --ignore doc $PKGNAME && cond_exit && break; done 
    fi
    ...
    echo "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++"
    if [ "$PKGTYPE" = "python" ]; then
	cond_exec "vérification du paquetage" && while true; do checkpackage_python && cond_exit && break; done
    fi
